...
const TestsScreen = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] pb-16 antialiased selection:bg-indigo-500 selection:text-white">
            ...
            <header className="bg-indigo-900 text-white p-5 shadow-sm sticky top-0 z-50 backdrop-blur-md bg-indigo-900/95">
                <div className="max-w-6xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/" className="hidden sm:flex items-center gap-1.5 text-indigo-300 hover:text-white text-xs font-semibold transition-colors border-l border-indigo-700 pl-4">
            ...
            {/* Header trang thu gọn (hero marketing đầy đủ giờ nằm ở trang chủ "/") */}
            <div className="bg-gradient-to-br from-indigo-950 via-indigo-900 to-slate-900 text-white py-12 px-6 shadow-md border-b border-indigo-950">
                <div className="max-w-4xl mx-auto text-center space-y-3">
                    <h2 className="text-3xl md:text-4xl font-black tracking-tight leading-tight">Danh sách đề thi luyện tập</h2>
